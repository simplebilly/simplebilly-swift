...
# **listNotifications**
```swift
    open class func listNotifications(completion: @escaping (_ data: [NotificationDto]?, _ error: Error?) -> Void)
```
...
NotificationsAPI.listNotifications() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **markAllRead**
```swift
    open class func markAllRead(completion: @escaping (_ data: Int64?, _ error: Error?) -> Void)
```
...
NotificationsAPI.markAllRead() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **markAsRead**
```swift
    open class func markAsRead(id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
NotificationsAPI.markAsRead(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **unreadCount**
```swift
    open class func unreadCount(completion: @escaping (_ data: Int64?, _ error: Error?) -> Void)
```
...
NotificationsAPI.unreadCount() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
