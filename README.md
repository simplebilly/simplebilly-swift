# SimpleBilly Swift SDK

[![Release](https://img.shields.io/github/v/release/simplebilly/simplebilly-swift?label=release&logo=github)](https://github.com/simplebilly/simplebilly-swift/releases)
[![CI](https://github.com/simplebilly/simplebilly-swift/actions/workflows/release.yml/badge.svg)](https://github.com/simplebilly/simplebilly-swift/actions/workflows/release.yml)
[![CodeQL](https://github.com/simplebilly/simplebilly-swift/actions/workflows/codeql.yml/badge.svg)](https://github.com/simplebilly/simplebilly-swift/actions/workflows/codeql.yml)
[![Scorecard](https://github.com/simplebilly/simplebilly-swift/actions/workflows/scorecard.yml/badge.svg)](https://github.com/simplebilly/simplebilly-swift/actions/workflows/scorecard.yml)
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/simplebilly/simplebilly-swift/badge)](https://scorecard.dev/viewer/?uri=github.com/simplebilly/simplebilly-swift)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Docs](https://img.shields.io/badge/docs-simplebilly.com-blue)](https://simplebilly.com/api/docs)

Official Swift client for the [SimpleBilly API](https://simplebilly.com/api/docs).
...
> published under [Releases](https://github.com/simplebilly/simplebilly-swift/releases).

## Installation

The package is published to the Swift package registry (and to [GitHub Packages](https://github.com/orgs/simplebilly/packages) for public repos — free for public packages).
See the [Releases](https://github.com/simplebilly/simplebilly-swift/releases) page for the list
