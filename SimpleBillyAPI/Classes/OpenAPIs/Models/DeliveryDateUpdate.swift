...
public struct DeliveryDateUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(customerId: String? = nil, fulfilledDate: Date? = nil, note: String? = nil, orderNumber: String? = nil, originalDate: Date? = nil, productId: String? = nil, promisedDate: Date? = nil, status: DeliveryDateStatus? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(promisedDate, forKey: .promisedDate)
