...
public struct SupplierConditionUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(currency: String? = nil, deliveryTerms: String? = nil, earlyPaymentDiscountPercent: String? = nil, isDefault: Bool? = nil, minimumOrderValue: String? = nil, notes: String? = nil, paymentDueDays: Int? = nil, paymentTerms: String? = nil, supplierContactId: String? = nil, supplierName: String? = nil, volumeDiscountTiers: AnyCodable? = nil) {
