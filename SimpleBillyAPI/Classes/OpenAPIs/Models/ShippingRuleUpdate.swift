...
public struct ShippingRuleUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(carrier: String? = nil, country: CountryCode? = nil, deliveryTime: String? = nil, isActive: Bool? = nil, maxWeightKg: Double? = nil, minWeightKg: Double? = nil, name: String? = nil, notes: String? = nil, price: String? = nil, priority: Int? = nil) {
