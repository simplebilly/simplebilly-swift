...
public struct CouponUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(code: String? = nil, description: String? = nil, discountType: DiscountType? = nil, discountValue: String? = nil, expiresAt: Date? = nil, isActive: Bool? = nil, isCombineable: Bool? = nil, maxDiscountAmount: String? = nil, maxUses: Int? = nil, maxUsesPerCustomer: Int? = nil, minOrderAmount: String? = nil, productIds: AnyCodable? = nil, startsAt: Date? = nil) {
        self.code = code
