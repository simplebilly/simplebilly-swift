...
public struct ActivityUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(activityType: ActivityType? = nil, assignedTo: String? = nil, contactId: String? = nil, description: String? = nil, dueDate: Date? = nil, reminderDate: Date? = nil, status: ActivityStatus? = nil, subject: String? = nil) {
