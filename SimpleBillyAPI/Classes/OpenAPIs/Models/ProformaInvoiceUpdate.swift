...
public struct ProformaInvoiceUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(convertedAt: Date? = nil, convertedToInvoiceId: String? = nil, currency: CurrencyCode? = nil, customerId: String? = nil, customerSnapshot: AnyCodable? = nil, issueDate: Date? = nil, lineItems: AnyCodable? = nil, notes: String? = nil, orderNumber: String? = nil, paymentDueDate: Date? = nil, quotationId: String? = nil, status: ProformaInvoiceStatus? = nil, subtotal: String? = nil, totalAmount: String? = nil, totalTax: String? = nil) {
