...
public struct ProductVariantCreate: Codable, JSONEncodable, Hashable {
    ...
    public init(barcode: String? = nil, imageLink: String? = nil, isActive: Bool? = nil, name: String? = nil, optionValues: AnyCodable? = nil, price: String? = nil, priceDelta: String? = nil, productId: UUID, sku: String, stockQuantity: Int64? = nil) {
