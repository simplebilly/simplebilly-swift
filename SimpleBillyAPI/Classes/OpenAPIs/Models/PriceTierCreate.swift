...
public struct PriceTierCreate: Codable, JSONEncodable, Hashable {
    ...
    public init(customerGroupId: String? = nil, minQuantity: Int64? = nil, productId: UUID, unitPrice: String) {
